      ...
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <nav className="hidden md:block">
          <ul className={`flex ${isRTL ? 'space-x-reverse' : ''} space-x-6`}>
            ...
            <li>
              <Link
                href="/laravel-api"
                className={`font-medium hover:text-primary transition-colors ${location.startsWith("/laravel") ? "text-primary" : ""}`}
              >
                {t('Laravel API', 'Laravel API')}
              </Link>
            </li>
            <li>
              <Link
        ...
        <div className={`flex items-center ${isRTL ? 'space-x-reverse' : ''} space-x-4`}>
          ...
          <Button className="bg-primary hover:bg-primary/90 text-white rounded-md shadow-sm">
            <MapPinIcon className={`${isRTL ? 'ml-2' : 'mr-2'} h-4 w-4`} />
        ...
        <div className="md:hidden px-4 py-3 bg-white border-t">
          <ul className="space-y-3">
            ...
            <li>
              <Link
                href="/laravel-api"
                className={`block font-medium hover:text-primary transition-colors ${location.startsWith("/laravel") ? "text-primary" : ""}`}
                onClick={() => setIsMenuOpen(false)}
              >
                {t('Laravel API', 'Laravel API')}
              </Link>
